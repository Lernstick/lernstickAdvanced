...
@echo off
for /f "tokens=* USEBACKQ" %%a in (`powershell -NoProfile -Command "Get-CimInstance -ClassName Win32_LogicalDisk | ? {$_.FileSystem -like 'NTFS'} | Select-Object -ExpandProperty Caption"`) do (
